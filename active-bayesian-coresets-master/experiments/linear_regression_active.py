...
parser.add_argument("--use_gpu", dest="use_gpu", default=True, action="store_true",
...
# optimization params
parser.add_argument('--training_epochs', type=int, default=3000, help='Number of training iterations')
...
parser.add_argument('--budget', type=int, default=3000, help='Active learning budget')
...
if __name__ == '__main__':
    ...
    while len(data.index['train']) < args.init_num_labeled + args.budget:
        ...
        test_nll, test_performance = nl.test(data, args.save_dir, start_time, args.dataset)
