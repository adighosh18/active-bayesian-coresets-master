...
parser.add_argument("--init_num_labeled", type=int, default=10000, help="Number of labeled observations in dataset")
parser.add_argument("--dataset", default='mnist', help="Torchvision dataset")
...
parser.add_argument('--budget', type=int, default=1000, help='Active learning budget')
...
if __name__ == '__main__':
    ...
    while len(data.index['train']) < args.init_num_labeled + args.budget:
        ...
        test_nll, test_performance = nl.test(data, args.save_dir, args.dataset, start_time, transform=test_transform)
