...
parser.add_argument("--eval_at", default='num_samples', help="x-axis, e.g. num_evals, wt, num_samples")
        ...
        if file.endswith(".pkl"):
            ...
            with open(os.path.join(args.load_dir, file), 'rb') as f:
                ...
                try:
                    ...
                    f = interp1d(evals, res, fill_value="extrapolate")
...
if __name__ == '__main__':
    ...
    metric = args.metric if args.metric != 'Accuracy' else 'Acc'
